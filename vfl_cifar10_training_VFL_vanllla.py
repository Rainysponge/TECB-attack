...
def main(device, args):
    ...
    for seed in range(5):
        ...
        for epoch in range(args.start_epoch, args.epochs):
            ...
            myLog.info('epoch %d args.lr %e ' % (epoch, args.lr))
            ...
            myLog.info(
                "epoch: {}, train_loss: {}, test_loss: {}, top1_acc: {}, top5_acc: {}" % (epoch, train_loss, test_loss, top1_acc, top5_acc)
            )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_save_path', type=str, required=True, help='log_save_path')
    ...
    device = args.device
    global myLog
    myLog = Log("aux_train_ba_model", parse={"log_save_path": args.log_save_path})
